"""Schema constants for the EOLO ThetaHarvest KB (v1.2 Excel).
...
DEFAULT_KB_PATH: Path = REPO_ROOT / "llm_engine_eolo" / "kb" / "EOLO_ThetaHarvest_v1.2.xlsx"

# All sheets we expect the v1.2 workbook to expose.
...
# case_quality vocabulary observed in the v1.2 workbook.
